...
public class VuforiaGLView extends GLSurfaceView {
    ...
    private static final String LOGTAG = "Vuforia - GLView";
    ...
    public void init(boolean translucent, int depth, int stencil) {
        ...
        //This is going to be done in our custom config chooser.
        //See ConfigChooser class definition below.
    ...
    private static class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
        ...
        public EGLConfig chooseConfig(EGL10 egl, EGLDisplay display) {
            ...
            //We use a minimum size of 4 bits for red/green/blue,
            //but will perform actual matching in chooseConfig() below.
