...
//Interface to be implemented by the activity which uses the AR module
public interface VuforiaControl {
    ...
    //To be called to start tracking with the initialized trackers and their loaded data
