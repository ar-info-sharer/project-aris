...
public class VuforiaMath {
    ...
    private static void projectScreenPointToPlane(Matrix44F inverseProjMatrix,
        ...
        float y = (point.getData()[1] - halfScreenHeight) / halfViewportHeight * -1;
        ...
        pointOnNearPlane = Vec4FDiv(pointOnNearPlane, pointOnNearPlane.getData()[3]);
        pointOnFarPlane = Vec4FDiv(pointOnFarPlane, pointOnFarPlane.getData()[3]);
    ...
    public static Vec3F getPointToPlaneIntersection(Matrix44F inverseProjMatrix,
                                                    Matrix44F modelViewMatrix,
                                                    float screenWidth,
                                                    float screenHeight,
                                                    Vec2F point,
                                                    Vec3F planeCenter,
                                                    Vec3F planeNormal) {
        projectScreenPointToPlane(inverseProjMatrix,
                                  modelViewMatrix,
                                  screenWidth,
                                  screenHeight,
                                  point,
