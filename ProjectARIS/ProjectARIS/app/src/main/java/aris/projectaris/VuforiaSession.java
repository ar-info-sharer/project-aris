...
public class VuforiaSession implements Vuforia.UpdateCallbackInterface {
    ...
    public void initAR(Activity activity, int screenOrientation) {
        ...
        //Use an OrientationChangeListener here to capture all orientation changes.
        //Android will not send an Activity.onConfigurationChanged() callback on a 180 degree
        //rotation, ie: Left Landscape to Right Landscape.
        //Vuforia needs to react to this change
        //and the VuforiaSession needs to update the Projection Matrix.
        ...
        //NOTE: This task instance must be created and invoked on the UI thread
        //and it may only run once!
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            synchronized (mShutdownLock) {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags,
                        "");
                do {
                    ...
                    //This is necessary as the AsyncTask will run to completion regardless of
                    //the status of the component that started is.
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                ...
                //NOTE: Check if initialization failed because the device is not supported.
                //At this point the user should be informed with a message.
                ...
                //Send Vuforia Exception to the application and call
                //initDone to stop initialization process
                vuforiaException = new VuforiaException(
                        VuforiaException.INITIALIZATION_FAILURE,
                        logMessage);
                mSessionControl.onInitARDone(vuforiaException);
    ...
    public void configureVideoBackground() {
        ...
        //  int widestVideo = xSize > ySize? xSize: ySize;
        //  int widestScreen = width > height? width: height;
