...
public class VuforiaTexture {
    ...
    public static VuforiaTexture loadTextureFromApk(String fileName, AssetManager assets) {
    ...
    public static VuforiaTexture loadTextureFromIntBuffer(int[] data, int width, int height) {
        //Convert:
        ...
        VuforiaTexture texture = new VuforiaTexture();
